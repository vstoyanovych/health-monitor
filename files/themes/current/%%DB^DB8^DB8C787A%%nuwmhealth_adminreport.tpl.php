<?php /* Smarty version 2.6.26, created on 2025-11-14 19:02:35
...
" class="admin-link"><?php echo ((is_array($_tmp=$this->_tpl_vars['row']['admin_label'])) ? $this->_run_mod_handler('escape', true, $_tmp) : smarty_modifier_escape($_tmp)); ?>
                        ...
                        <td class="text-center"><?php echo $this->_tpl_vars['row']['total']; ?>
</td>
                        <td class="text-center text-success"><?php echo $this->_tpl_vars['row']['ready']; ?>
</td>
                        <td class="text-center text-danger"><?php echo $this->_tpl_vars['row']['missing']; ?>
</td>
